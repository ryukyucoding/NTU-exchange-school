...
## 💭 專題製作心得
- 莊孟芸
感覺專題的規模就是整個作業的大集合。一開始花了不少時間在定義每個功能應該怎麼運作，以及是否有必要性，大概是相較於作業最不一樣的地方，畢竟想做的很多，會希望能夠做到真正對大家在計劃交換時有最大的助益。此外在 AI 的幫助下雖然能夠很快地看到一些功能的雛形，但要能順利的運作以及用有一致的視覺風格也是需要不少時間。非常感謝大家很扛大做專題很多天><太扛了

- 劉軒羽
很喜歡這次的湯圓！這學期開始有同學校交換了，自己也在查詢相關資訊的時候處處碰壁（偷嘴台大的交換學校查詢網站真的很難用），因此有了這個專案的想法雛形。原本只是想有個篩選功能，沒想到可以發展到把整個社群架進來的規模（感謝組員的肝，社群有超多細節等大家來玩），也很用心的去爬了台大國際事務處中很多學生的交換心得，把所有資訊都整理在一起了！是真的希望大家能夠來使用這個網站，也期望我們的湯圓寶寶之後可以成功上線！
 
- 汪芷瑩
期末專題感覺真的是一個大集合，把正確上課、做作業時學到的知識跟技巧都用上了，雖然做的過程很累，但是還是蠻開心能很好的使用到這學期的所學的東西，有很明顯的感受到自己的成長！感謝組員們的用心，大家都很認真在完善整個專案架構以及所有的小細節，有大家的堅持才有最後這麼好的成果，愛大家🫰🏻
